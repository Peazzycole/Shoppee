                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14" style="text-decoration: none;">20,534
                                ratings | 1000+ answered
                                questions</a>
                        </div>
                        <hr class="m-0">
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-rale font-size-14">
                                <td>Deal Price:</td>
                                <td class="font-size-20 text-danger">$<span><?php echo $item['item_price'] ?>.00</span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                            </tr>
                            <tr class="font-rale font-size-14">
                                <td>You Save:</td>
                                <td><span class="font-size-16 text-danger"><?php echo $item['item_price'] ?>.00</span></td>
                            </tr>
                        </table>
                        <!---    !product price       -->
                            ...
                            <div class="d-flex">
                                ...
                                <div class="return text-center me-5">
                                    ...
                                    <a href="#" class="font-rale font-size-12" style="text-decoration: none;">Daily
                                        Tuition <br>Deliverd</a>
                                </div>
                                <div class="return text-center me-5">
                                    <div class="font-size-20 my-2 color-second">
                                        <span class="fas fa-check-double border p-3 rounded-pill"></span>
                                    </div>
                                    <a href="#" class="font-rale font-size-12" style="text-decoration: none;">1 Year
                                        <br>Warranty</a>
                                </div>
                            </div>
                        </div>
